...
export default function GenericSalesPage() {
    ...
    const moduleName = (type as string)?.toUpperCase() || 'SALES';

    const columns = [
        { header: 'Number', accessor: (v: any) => v.no },
        { header: 'Customer', accessor: (v: any) => v.customer },
        ...
        <MainLayout>
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Sales {moduleName}</h1>
                        <p className="text-slate-500 mt-1">Manage your customer {moduleName.toLowerCase()} documents.</p>
                    </div>

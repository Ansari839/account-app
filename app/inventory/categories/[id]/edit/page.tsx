...
export default function EditCategoryPage({ params }: { params: { id: string } }) {
    ...
    const { id } = React.use(params as unknown as Promise<any>);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [resCat, resAll, resAcc] = await Promise.all([
                ...
                if (jsonCat.success) {
                    setFormData({
                        ...
                        isService: jsonCat.data.isService || false,
                        wipAccountId: jsonCat.data.wipAccountId || ''
                    });
                }
            ...
            <div className="max-w-3xl mx-auto space-y-6 pb-32 animate-in fade-in duration-500">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 text-sm font-bold text-slate-400">
                        <Tags size={16} className="text-pink-500" /> Edit Category
                    </div>
                </div>
                ...
                <div className="bg-slate-950 rounded-[2rem] p-8 shadow-2xl shadow-pink-500/10 relative border border-slate-800">
                    ...
                    <div className="relative z-10">
                        <h1 className="text-4xl font-black text-white tracking-tight">Edit Category</h1>

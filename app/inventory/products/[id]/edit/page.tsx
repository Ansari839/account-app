    ...
    const fetchData = async () => {
        try {
            const [catRes, unitRes, prodRes] = await Promise.all([
                ...
                authenticatedFetch(`/api/inventory/products/${id}`)
            ]);
            ...
            <div className="max-w-5xl mx-auto space-y-6 pb-32 animate-in fade-in duration-500">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 text-sm font-bold text-slate-400">
                        <PackageSearch size={16} className="text-violet-500" /> Edit Item
                    </div>
                </div>
                    ...
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                        <div className="col-span-12 md:col-span-5 space-y-4">
                            <div>
                                ...
                                <p className="text-slate-400 font-medium mt-1">Update item details</p>
                            </div>
